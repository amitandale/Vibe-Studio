...
export function createFileToContentBlock(
  reader: (file: File) => Promise<string> = fileToBase64,
) {
  return async function fileToContentBlock(
    file: File,
...
export const fileToContentBlock = createFileToContentBlock();
